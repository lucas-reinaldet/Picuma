...
public class FragmentPerfilEmpresaGaleria extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = getEmpresaControl().getViewGaleriaEmpresa(inflater, container);
        FragmentManager fragmentManager = getFragmentManager();
        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
        fragmentTransaction.replace(R.id.container_perfil_empresa_galeria, new FragmentPerfilEmpresaListaGaleria(), "fotos_galeria");
