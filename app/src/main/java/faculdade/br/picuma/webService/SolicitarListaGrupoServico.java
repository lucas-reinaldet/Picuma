...
public class SolicitarListaGrupoServico extends AsyncTask<Void, Void, List<GrupoServico>> {
    @Override
    protected List<GrupoServico> doInBackground(Void... v) {

        String endereco = Constantes.URL_CONEXAO_WEB_SERVICE + Constantes.PATH_SERVICOS_OFERTADOS + Constantes.PATH_LISTAR_GRUPO_SERVICO;
