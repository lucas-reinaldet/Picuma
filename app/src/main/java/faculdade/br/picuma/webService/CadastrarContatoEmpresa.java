...
public class CadastrarContatoEmpresa extends AsyncTask<String, Void, List<Contato>> {

    @Override
    protected List<Contato> doInBackground(String... strings) {

        String endereco = Constantes.URL_CONEXAO_WEB_SERVICE + Constantes.PATH_SERVICOS_OFERTADOS + Constantes.PATH_CADASTRAR_CONTATO_EMPRESA;
        ...
        try {
            ...
            if (HttpResult == HttpURLConnection.HTTP_OK) {
                ...
                if (line != null && !line.isEmpty()) {
                    Type dados = new TypeToken<List<Contato>>() {
                    }.getType();
