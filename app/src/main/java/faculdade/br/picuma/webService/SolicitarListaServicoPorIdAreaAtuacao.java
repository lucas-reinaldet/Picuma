...
public class SolicitarListaServicoPorIdAreaAtuacao extends AsyncTask<Integer, Void, List<Servico>> {
    @Override
    protected List<Servico> doInBackground(Integer... v) {

        String endereco = Constantes.URL_CONEXAO_WEB_SERVICE + Constantes.PATH_SERVICOS_OFERTADOS + Constantes.PATH_LISTAR_SERVICO_AREA_ATUACAO;
