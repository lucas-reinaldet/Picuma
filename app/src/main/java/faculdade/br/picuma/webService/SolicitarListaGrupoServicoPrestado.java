...
public class SolicitarListaGrupoServicoPrestado extends AsyncTask<Integer, Void, List<GrupoServico>> {
    @Override
    protected List<GrupoServico> doInBackground(Integer... v) {

        String endereco = Constantes.URL_CONEXAO_WEB_SERVICE + Constantes.PATH_SERVICOS_OFERTADOS + Constantes.PATH_LISTAR_GRUPO_SERVICO_PRESTADO;

        URL url = null;
        List<GrupoServico> listaGrupoServicoPrestado = null;
        try {
            ...
            if (HttpResult == HttpURLConnection.HTTP_OK) {
                ...
                if (line != null) {
                    ...
                    listaGrupoServicoPrestado = new Gson().fromJson(line, dados);
